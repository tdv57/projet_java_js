...
@Api(tags = "History")
@Tag(name = "History", description = "Opération sur les listes de films vus par utilisateur")
public interface HistoryController {
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 204, message = "La liste des films a été mise à jour correctement")
    })
    ResponseEntity<?> removeFromWatchList(long userId, long filmId) throws ControllerException;
