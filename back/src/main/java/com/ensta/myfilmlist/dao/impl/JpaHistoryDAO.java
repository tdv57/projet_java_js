...
public class JpaHistoryDAO implements HistoryDAO {
    ...
    Optional<History> findHistoryByUserIdAndFilmId(long userId, long filmId) throws ServiceException {
        System.err.println("findHistoryByUserIdAndFilmId");
        try {
            ...
            throw new ServiceException("Can't find Film in watched list of User");
        }
    }
